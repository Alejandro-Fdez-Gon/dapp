module.exports = async callback => {
    ...
    try {
        ...
        await asignatura.addProfesor(profe2Addr, "Joaquin Salvachua");
        ...
        await asignatura.automatricula("Eva Martinez", "11111111A", "em@dominio.es", {from: evaAccount});
        await asignatura.automatricula("Jose Redondo", "22222222B", "jr@sitio.com", {from: pepeAccount});
        await asignatura.automatricula("Luis Martin",  "33333333C", "lm@aqui.com", {from: luisAccount});
